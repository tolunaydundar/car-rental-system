...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string BrandNotFound = "This brand could not be found.";
        ...
        public static string CarNotFound = "This car could not be found.";
        ...
        public static string CategoryNotFound = "This category could not be found.";
        ...
        public static string ColorNotFound = "This color could not be found.";
        ...
        public static string CustomerNotFound = "This customer could not be found.";
        ...
        public static string RentalNotFound = "This rental could not be found.";
        ...
        public static string UserNotFound = "This user could not be found";
